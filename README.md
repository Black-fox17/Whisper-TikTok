...
Remember to handle the responses from these functions appropriately. This may include checking for any 'wait' status and resending requests or processing the received images and audio files.
